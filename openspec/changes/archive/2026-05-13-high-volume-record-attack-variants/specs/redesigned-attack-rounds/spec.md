...
- **THEN** 2500 DiffEntry records of type "modified" SHALL be produced with size = original * (0.80 + random * 0.10), NO file extension change, timestamps within 300 seconds of attack time
