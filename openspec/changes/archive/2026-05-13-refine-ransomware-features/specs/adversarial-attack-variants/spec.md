...
The IntermittentEncryptionBenchmark SHALL test all 8 adversarial variants at 3 padding levels (20%, 50%, 70%), producing 24 adversarial test cases, using the new 12-feature scoring system with rebalanced weights.

The benchmark SHALL report detection results with emphasis on the previously-missed variants:
...
- **THEN** it SHALL test attack cases using 12-feature vectors and rebalanced weights
